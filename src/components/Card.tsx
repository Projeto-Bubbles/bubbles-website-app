...
function Card(props: CardProps) {
  return (
    <div className="bg-gray-700 text-slate-100 flex flex-col gap-4 justify-start p-6 rounded-md h-full transition-all ease-out duration-500 group hover:bg-slate-800">
      {props.icon && (
